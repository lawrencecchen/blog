...
I'm biased and an early adopter of new tools, so take my predictions with a grain of salt.
...
For Google, an open source Chromium based competitor hasn't really reached critical mass yet. Currently, I can't imagine a killer use case for AI in a browser. But I didn't predict that cmd+[i,l,k] could sufficiently grow a new code editor to critical mass. Computer use would be an obvious prediction. Maybe a browser that tests changes to my codebase and then takes screenshots of the changes would be a killer feature for me (a dev). But I can't currently think of a killer consumer use case.